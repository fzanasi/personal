angular.module('admin', [])
  ...
  .controller('AdminCtrl', ['$http', '$scope', function($http, $scope) {
    ...
    var computeMissingCollaborators = function() {
      ...
      collaborators.push('Fabio Zanasi');
  ...
  .config(['$routeProvider', '$locationProvider',
    function($routeProvider, $locationProvider) {
      $routeProvider
        ...
        .when('/UGprojects.html', {
          templateUrl: 'UGprojects.html'
        })
/*        .when('/phdposition.html', {
          templateUrl: 'phdposition.html'
        })
        .when('/calendar.html', {
...
*/
  ...
  .controller('NavCtrl', ['$scope', '$location', function($scope, $location) {
    $scope.menuItems = [
      { href: '#/main.html', icon: 'home', text: 'Home' },
...
/*       { href: '#/activities.html', icon: 'plane', text: 'Activities' },*/
/*      { href: '#/calendar.html', icon: 'calendar', text: 'Calendar' },

      { href: '#/phdposition.html', icon: 'eye-open', text: 'PhD Positions' }
/*      { href: 'files/thesis2015.pdf', icon: 'download-alt', text: 'PhD thesis' }*/
    ];
